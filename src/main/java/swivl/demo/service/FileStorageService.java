...
import swivl.demo.service.exception.MyFileNotFoundException;
    ...
    public String storeFile(MultipartFile file) throws FileStorageException {
        ...
        try {
            ...
            if(fileName.contains("..")) {
                throw new FileStorageException("Sorry! Filename contains invalid path sequence " + fileName, new IOException());
            }
